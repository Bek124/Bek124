 ...
 */
define('API_KEY', "5172903621:AAFm9y0ChezgrPcBrUxe7pSc6UauXMCnOPE"); 

$botname = "MajburiyAbot";///ARCRED_PUBGM
...
Yordam : =>  /qollanma ",
    ...
    [['text'=>"➕ Guruhga qo'shish",'url'=>"https://t.me/$botname?startgroup=new"]],
        [['text'=>"😌Guruhimiz",'url'=>"https://t.meARCRED_PUBGM/"]],
    ]
        ])
    ]);
}
...
✅Namuna:*`/setchannel @ARCRED_PUBGM`",
    'parse_mode'=>"markdown",
...
Masalan : /setchannel @ARCRED_PUBGM
...
📊Yangiliklar  @Firdavs2004",
    ...
    'inline_keyboard'=>[
    [['text'=>"➕ Guruhga qo'shish",'url'=>"https://t.me/$botname?startgroup=new"]],
        [['text'=>"Guruhimiz",'url'=>"https://t.me/ARCRED_PUBGM"]],,
    ]
        ])
    ]);
}
